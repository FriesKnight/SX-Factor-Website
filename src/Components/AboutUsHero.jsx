    ...
    return (
        <div className="relative w-full h-[100vh] overflow-hidden">
            ...
            >
                ...
                <h1 className="text-5xl md:text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-red-600 via-gray-600 to-white hover:bg-gradient-to-r hover:from-red-600 hover:via-yellow-400 hover:to-yellow-600 transition-all duration-300 drop-shadow-lg">
                    SX Factor Sdn Bhd
                </h1>
